...
class ModelOutputs:
    ...
    def __init__(self, model, target_layers):
        self.model = model
        self.feature_extractor = FeatureExtractor(model.resnest50, target_layers)
    ...
    def __call__(self, x):
        ...
        output = self.model.ReLU1(output)
...
class GradCam:
    ...
    def __call__(self, input, index=None):
        ...
        self.model.resnest50.zero_grad()
        self.model.ReLU1.zero_grad()
...
if __name__ == '__main__':
    ...
    test_model = "./models_pkl/model_best_3_focal_50_0.3_1000.pth.tar"
    ...
    for image_name in images:
        ...
        # output_path = "./data/cam_csae_new/" + str(num_index) + "_" + str(i) + "_" +str(strftime("%m_%d_%H_%M_%S", localtime())) + ".jpg"
        output_path = "./data/cam_csae_new/" + str(num_index) + "_" + str(i) + ".jpg"
        i = i + 1
